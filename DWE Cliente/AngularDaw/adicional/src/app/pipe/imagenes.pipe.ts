...
@Pipe({
  name: 'imagenes', // nombre del pipe.(para invocar este pipe)
  standalone: false,
})

export class ImagenesPipe implements PipeTransform {
  /**
   * El método transform toma un valor de tipo string[] (una lista de cadenas) o undefined, 
   * y retorna un string. Los args son parámetros adicionales opcionales que se pueden usar 
   * para personalizar el comportamiento del pipe.
   */
